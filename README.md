...
```bash
git clone [https://github.com/schoo7/SRA_LLM.git](https://github.com/schoo7/SRA_LLM.git)
cd SRA_LLM
2. Create and Activate Python Virtual EnvironmentIt is highly recommended to use a Python virtual environment to manage dependencies.Create the environment (e.g., named sra_llm):python3 -m venv sra_llm
